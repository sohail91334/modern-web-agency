          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {featuredProjects.map((project, i) => (
              <Reveal key={project.slug} delay={i * 100}>
                <Link href={`/portfolio/${project.slug}`} className="group block overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-slate-100 transition-all hover:shadow-xl">
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-brand-500 via-brand-600 to-accent-500 px-8 py-16 text-center sm:px-16 lg:py-24">
              ...
              <div className="relative">
                ...
                <div className="mt-8 flex flex-wrap justify-center gap-4">
                  <Link href="/contact" className="btn bg-white text-brand-700 hover:bg-slate-100 hover:shadow-lg">
                    Get a free quote
                    <ArrowRight className="h-4 w-4" />
                  </Link>
                  <Link href="/pricing" className="btn border border-white/40 bg-transparent text-white hover:bg-white/10">
                    View pricing
                  </Link>
                </div>
